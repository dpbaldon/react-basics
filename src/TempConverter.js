...
// when user types in the input field for the fahrenheit, we'll get set the value of
// fahrenheit to the user input, then convert the value to Celsius, which will reflect
// in the other field
